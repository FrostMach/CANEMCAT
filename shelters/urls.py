...
urlpatterns = [   
    ...
    path('events/', views.user_events, name='user-events'),  # Para ver los eventos
    path('events/edit/<int:event_id>/', views.edit_event, name='edit-event'),  # Para editar un evento
    path('events/delete/<int:event_id>/', views.delete_event, name='delete-event'),  # Para eliminar un evento
